...
Em auditoria Lighthouse mobile com throttling padrão, a home MUST atingir LCP ≤ 2.0s, CLS ≤ 0.02, INP ≤ 200ms e pontuação de desempenho ≥ 95. O elemento LCP MUST ser texto renderizado pelo servidor.
